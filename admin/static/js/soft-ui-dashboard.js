...
function sidebarColor (a) {
  ...
  if (document.querySelector('#sidenavCard')) {
    ...
    const sidenavCardClasses = ['card', 'card-background', 'shadow-none', 'card-background-mask-' + color]
    sidenavCard.className = ''
    sidenavCard.classList.add(...sidenavCardClasses)

    let sidenavCardIcon = document.querySelector('#sidenavCardIcon')
    const sidenavCardIconClasses = ['ni', 'ni-diamond', 'text-gradient', 'text-lg', 'top-0', 'text-' + color]
